...
# app imports
from stockings.models.depot import Depot, DepotItem, DepotItemCashflow
...
@admin.register(DepotItemCashflow)
class DepotItemCashflowAdmin(admin.ModelAdmin):  # noqa: D101
    pass
