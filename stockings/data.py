...
"""Provide a common interface to pass money-related values around."""
...
class StockingsMoney:
    ...
    Django's ORM layer. However, ``django-stockings`` relies on all
    time-related data to be timezone-aware.
    ...
    timestamp : datetime.datetime, optional
        ...
        time, as provided by Django's wrapper to `now`. This has to be a
    ...
    ValueError
        If a naive datetime is used for the ``timestamp``
    """
