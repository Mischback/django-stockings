...
import stockings  # noqa isort:skip
...
project = stockings.__app_name__
author = stockings.__author__
copyright = "{}, {}".format(datetime.datetime.now().year, author)
version = stockings.__version__
release = version
...
modindex_common_prefix = ["stockings."]
...
extlinks = {
    ...
    "commit": ("https://github.com/mischback/django-stockings/commit/%s", ""),
    # will show "issue [number]"
    "issue": ("https://github.com/mischback/django-stockings/issues/%s", "issue "),
    # A file or directory. GitHub redirects from blob to tree if needed.
    # will show file/path relative to root-directory of the repository
    "source": ("https://github.com/mischback/django-stockings/blob/master/%s", ""),
...
html_theme_options = {
    # 'canonical_url': 'http://django-stockings.readthedocs.io',  # adjust to real url
