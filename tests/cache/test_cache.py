"""Tests for module `stockings.cache.cache`."""
...
# app imports
from stockings.cache.cache import (
...
class StockingsCacheTest(StockingsTestCase):
    """Provides tests for module `stockings.cache.cache`."""

    @mock.patch("stockings.cache.cache.cache")
    ...
    @mock.patch("stockings.cache.cache.logger")
